...
MM.db = {
    ...
    _getCollection: function(collection) {
        ...
        if (MM.config.current_site !== undefined &&
            ...
            MM.collections[MM.config.current_site.id] !== undefined &&
            MM.collections[MM.config.current_site.id][collection] !== undefined
        ) {
            response = MM.collections[MM.config.current_site.id][collection];
    ...
    insert: function(collection, model) {
        ...
        if (collection !== undefined) {
            MM.log('Insert element into DB collection: ' + collectionName, 'DB');
    ...
    getSiteConfig: function() {
        var siteConfig = [];
        MM.db.each('settings', function(element) {
     ...
     *
     * @param {String} collection The collection to get all contents for
     *
     * @return {Object} A Backbone collection
     */
     ...
     *
     * @param {String} collection The collection to reset
     *
     * @return void
     */
