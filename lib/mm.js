...
var MM = {
    ...
    isOnline: function () {
        ...
        setInterval(function () {
            ...
            element.className = navigator.onLine ? 'fa fa-rss fa-rotate-44' : 'off fa fa-rss fa-rotate-44';
            element.title = navigator.onLine ? 'online' : 'offline';
            if (element.title !== oldStatus) {
                // Warning message
                MM.widgets.dialog(
                    "Connection lost", {
