...
console.log("Loading settings");
    ...
    homepageCallback: function(response) {
        var html = '<div class="panel-content home">';
        html += '<div class="sections has-user-content">';
        html += response;
        html += '</div>';
        html += '<button class="button view-menu">';
        html += MM.lang.s("home-viewmenu-show");
        html += '</button>';
        html += '<a href="#my-courses" class="button view-courses">';
        html += MM.lang.s("home-viewcourses");
        html += '</a>';
        html += '</div>';
