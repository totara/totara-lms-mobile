...
var MM = {
    ...
    isOnline: function () {
        ...
        setInterval(function () {
            console.log('are we onLine??? ' + MM.online_status );
            document.getElementById('online-status').className = navigator.onLine ? 'fa fa-rss fa-rotate-44' : 'off fa fa-rss fa-rotate-44';
            document.getElementById('online-status').title = navigator.onLine ? 'online' : 'offline';  
        }, 5000);
    },
    ...
    loadLayout: function() {
        ...
        if (typeof(current_site) != 'undefined' &&
            ...
            $("#url").combobox('setValue', document.location.origin);
