...
console.log("Loading settings");
    ...
    homepageCallback: function(response) {
        var html = '<div class="panel-content home"><div class="sections has-user-content">' + response + '</div><button class="view-menu">' + MM.lang.s("home-viewmenu") + '</button><button class="view-menu">' + MM.lang.s("home-viewcourses") + '</button></div>';
