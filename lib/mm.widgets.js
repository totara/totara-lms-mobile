...
MM.widgets = {
    ...
    dialog: function(text, options) {
        if (MM.widgets.dialogIsOpen === true) {
            return;
        } else {
            MM.widgets.dialogIsOpen = true;
        }
        ...
        $("#app-dialog .modalContent textarea").bind("focus", MM.widgets.delayedDialogSetTop);
        $("#app-dialog .modalContent input").bind("blur", MM.widgets.delayedDialogSetTop); 
        $("#app-dialog .modalContent textarea").bind("blur", MM.widgets.delayedDialogSetTop);
    },
